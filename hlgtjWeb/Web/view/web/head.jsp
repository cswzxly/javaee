    ...
    <div class="inner">
        ...
        <div class="nav">
            <ul>
                ...
                <li><a href="${ctx}/web/areaInfoList.action?type=zwgk&catalogID=68">通知通告</a></li>
                <li><a href="${ctx}/web/areaInfoMainList.action?type=ywgg&catalogID=180">业务公告</a></li>
                <li><a target="_blank" href="http://www.hlwb.gov.cn/wsdt/service?deptID=007035767&zone=hl&pid=0000">网上办事</a></li>
                <li><a href="fileInfoMainList.action?type=zlxz&catalogID=236">资料下载</a></li>
                ...
                <tr>
                    ...
                    <td class="search">
                        <form action="${ctx}/web/searchList.action" method="post">
                            <input type="text" class="search_text" placeholder="请输入关键字" name="title" value="${title}"/>
