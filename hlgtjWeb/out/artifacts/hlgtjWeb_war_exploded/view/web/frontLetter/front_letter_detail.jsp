...
<div class="wrapper">
	<div class="inner">
        ...
        <div class="main">
        	<div class="position"><span>当前位置：</span><a href="${ctx}/web/index.action">网站首页</a> > <b><c:if test="${flag eq '1'}">局长信箱</c:if><c:if test="${flag eq '2'}">业务咨询</c:if><c:if test="${flag eq '3'}">监督投诉</c:if>答复选登</b></div>                 
