...
<div class="wrapper">
	...
	<div class="content">	
        ...
        <div class="main">
            ...
            <div class="cont">
                ...
                <p align="right"><a href="${ctx }/web/front_replayLetter.action?flag=${flag}" style="font-size:24px;font-weight:bold;color:#f00;">答复选登</a></p>        	</div>
            </div>
    ...
    <!--         <input type="hidden" name="isOpen" value="0"/> -->
            ...
            <tr class="tbg">
                <td colspan="2"><div>建议人资料登记(注意带有*号必须填写；请填写电子邮箱，以方便我们向您反馈处理信息)</div></td>
            </tr>
    <%--         <c:choose> --%>
    ...
    <%--         </c:choose> --%>
            <tr>
                <th>姓名：</th>
                <td><input type="text" name="name" id="name" class="text" disabled="disabled"/><font color="red">*</font></td>
    ...
    <!--         </tr> -->
            <tr>
                <th>联系电话：</th>
                <td><input type="text" name="phone" id="phone" class="text" disabled="disabled"/></td>
    <!--             <th>手机号码：</th> -->
    <!--             <td><input type="text" name="moblePhone" id="moblePhone"/></td> -->
            </tr>
            <tr>
                <th>联系邮箱：</th>
                <td><input type="text" name="email" id="email" class="text" disabled="disabled"/></td>
    <!--             <th>邮编：</th> -->
    ...
    <!--         </tr> -->
            <tr>
                <th>主题：</th>
                <td><input type="text" name="theme" id="theme" class="text" disabled="disabled"><font color="red">*</font></td>
            </tr>
    <!--         <tr> -->
    <!--             <th>问题类别：</th> -->
    <!--             <td> -->
    ...
    <!--         </tr> -->
            <tr>
                <th>信息内容：</th>
                <td>
                    <textarea name="content" id="content" cols="60" rows="5" disabled="disabled"></textarea><font color="red">*</font>
