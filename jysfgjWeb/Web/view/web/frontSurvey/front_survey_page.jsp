	...
	<div class="inner">		
    	...
    	<div class="main">
            ...
            <div class="list">
                ...
                <tr>
                    <th>调查主题：</th>
                    <td colspan="3"><a href="${ctx }/web/front_querySurveyInfo.action?theID=${list.desId}">${list.title }</a></td>
                </tr>
                <tr>                    
                    <th>开始日期：</th>
            ...
            <div class="list">
                ...
                <tr>
                    <th>调查主题：</th>                   
                    <td colspan="3"><a href="${ctx }/web/front_querySurveyInfo.action?theID=${list.desId}&count=1">${list.title }</a></td>              		
                </tr>
                <tr>
                    <th>开始日期：</th>
                    <td><font color="green">${list.beginDate }</font></td>
