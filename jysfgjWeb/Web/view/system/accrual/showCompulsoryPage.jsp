...
<script>
    ...
    $(function () {
        ...
        $('#backContentsBtn').click(function () {
            window.location.href = "${ctx}/contents/contentsPage.action?catalog="+$("#catalogID").val();
        });
            ...
            <form id="newAccrualForm" method="post" action="${ctx}/accrual/saveEditAccrual.action">
                <table class="formtable">
                    ...
                    <tr>
                    	<th>行政强制措施：</th>
                        <td colspan="3">
                            <textarea name="accrual.compulsoryMeasures" id="accrual.compulsoryMeasures" cols="100" rows="10">${accrual.compulsoryMeasures}</textarea>
                        </td>
                    </tr>
                    <tr>
                    	<th>实施依据：</th>
