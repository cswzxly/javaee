...
<div id="newOtherPage" class="easyui-panel" title="新增内容" collapsible="false" minimizable="false"
        ...
        <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
            <form id="newAccrualForm" method="post" action="${ctx}/accrual/saveEditAccrual.action">
                <table class="formtable">
                    ...
                    <tr>
                        <th>项目名称：</th>
                        <td colspan="3"><input name="accrual.title" id="accrual.title" type="text" class="easyui-validatebox" value="${accrual.title }"/></td>
                    </tr>
                    <tr>
                        <th>发布日期：</th>
                        <td>
                            <input name="accrual.releaseDate" id="accrual.releaseDate" type="text" width="100" readonly="readonly" value="${accrual.releaseDate }"/>
                            <img onClick="WdatePicker({el:'accrual.releaseDate',dateFmt:'yyyy-MM-dd HH:mm:ss'})" src="${ctx}/resources/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">
                        </td>
                        <th>状态：</th>
                        <td>
                ...
                <div region="south" border="false" style="text-align: center; height: 50px; line-height: 50px;">
		            <a class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0)" onClick="newOtherPage.submitAccrual()">
		                保存</a>
		        </div>
            </form>
        </div>
