...
<div id="newPunishPage" class="easyui-panel" title="新增内容" collapsible="false" minimizable="false"
        ...
        <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
            <form id="newAccrualForm" method="post" action="${ctx}/accrual/saveEditAccrual.action">
                <table class="formtable">
                    ...
                    <tr>
                        <th>可予处罚的违法行为：</th>
                        <td colspan="3"><input name="accrual.title" id="accrual.title" value="${accrual.title }"type="text" class="easyui-validatebox" /></td>
                    </tr>
                    <tr>
                        <th>发布日期：</th>
                        <td>
                            <input name="accrual.releaseDate" id="releaseDate" type="text" width="100" readonly="readonly" value="${accrual.releaseDate }"/>
                    ...
                    <tr>
                    	<th>处罚种类：</th>
                        <td colspan="3">
                            <textarea name="accrual.punishType" id="accrual.punishType" cols="100" rows="10">${accrual.punishType}</textarea>
                        </td>
                    </tr>
                    <tr>
                    	<th>实施依据：</th>
                ...
                <div region="south" border="false" style="text-align: center; height: 50px; line-height: 50px;">
            		<a class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0)" onClick="newPunishPage.submitAccrual()">
                	保存</a>
        		</div>
            </form>
        </div>
<!--         <div region="south" border="false" style="text-align: center; height: 50px; line-height: 50px;"> -->
<!--             <a class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0)" onClick="newPunishPage.saveNewAccrual()"> -->
<!--                 保存</a> -->
<!--         </div> -->
    </div>
</div>
