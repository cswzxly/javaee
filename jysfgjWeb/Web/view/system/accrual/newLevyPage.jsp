            ...
            <form id="newAccrualForm" method="post" action="${ctx}/accrual/saveNewAccrual.action">
                <table class="formtable">
                    ...
                    <tr>
                        <th>发布日期：</th>
                        <td>
                            <input id="releaseDate" name="releaseDate" type="text" width="100" readonly="readonly" value="${now }"/>
                    ...
                    <tr>
                    	<th>征收标准：</th>
                        <td colspan="3">
                            <textarea name="levyStandard" id="levyStandard" cols="100" rows="10"></textarea>
                        </td>
                    </tr>
                    <tr>
                    	<th>实施依据：</th>
