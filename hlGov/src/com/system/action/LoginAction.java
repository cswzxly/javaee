...
public class LoginAction  extends BaseAction{
    ...
    private String patchcafield;//验证码
...
//        String c = (String)this.getRequest().getSession().getAttribute("PATCHCA");
...
//        if(userName==null||"".equals(userName)||password==null||"".equals(password)||patchcafield==null||"".equals(patchcafield)){
//            return ERROR;
//        }else if(!c.equals(patchcafield)){
...
//        }
	...
	public String getPatchcafield() {
		return patchcafield;
	}

	public void setPatchcafield(String patchcafield) {
		this.patchcafield = patchcafield;
	}
