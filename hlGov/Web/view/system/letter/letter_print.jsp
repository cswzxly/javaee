...
<tr>
    ...
    <td colspan="3">
    	<c:if test="${letter.status=='0'}">
    		<img src="${ctx}/resources/system/images/radio.jpg" align="absmiddle" /> 否
    		<img src="${ctx}/resources/system/images/radio.jpg" align="absmiddle" /> 是
    	</c:if>
    	<c:if test="${letter.status=='1' }">
	    	<c:if test="${letter.isOpen eq '1'}">
	    		<img src="${ctx}/resources/system/images/radio.jpg" align="absmiddle" /> 否
	    		<img src="${ctx}/resources/system/images/check.jpg" align="absmiddle" /> 是
	    	</c:if>
		    <c:if test="${letter.isOpen eq '0'}">
		    	<img src="${ctx}/resources/system/images/check.jpg" align="absmiddle" /> 否
	    		<img src="${ctx}/resources/system/images/radio.jpg" align="absmiddle" /> 是
	    	</c:if>
    	</c:if>
    </td>
...
<tr>
    ...
    <th>&nbsp;</th>
    <td colspan="3">
    	<input type="button" onClick="printdiv('div_print')" value="打印" class="button">	
