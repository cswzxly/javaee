...
var survey_page = {
    ...
    saveNewSurvey:function (){
        ...
        if(flag){
            ...
            var param = {};
            param.title = $("#title_save").val();
            param.summary = $("#summary_save").val();
            param.beginDate = $("#beginDate_save").val();
            param.endDate = $("#endDate_save").val();
...
<table id="dg" title="列表" style="width:700px;height:640px" data-options="
    ...
    <thead>
    <tr>
        <th field="title" width="150">调查主题</th>
