...
<table id="dg" title="文件列表" style="width:auto;height:600px" data-options="
				rownumbers:true,
				singleSelect:true,
				autoRowHeight:false,
				toolbar: '#tb',
...
<div id="newFileInfoWin" class="easyui-window" title="新建附件" collapsible="false" minimizable="false"
...
<div id="editFileInfoWin" class="easyui-window" title="编辑附件" collapsible="false" minimizable="false"
     maximizable="false" icon="icon-save"  style="width: 300px; height: 250px; padding: 5px;
         background: #fafafa;" data-options="left:'250px',top:'200px'">
    <div class="easyui-layout" fit="true">
        <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
